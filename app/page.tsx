export default function Home() {
  return (
    <main style={{ fontFamily: "system-ui, -apple-system, sans-serif", maxWidth: 760, margin: "0 auto", padding: "60px 20px", color: "#1a1a2e" }}>
      ...
      <div style={{ background: "#f8f8fa", borderRadius: 10, padding: 16, marginBottom: 24 }}>
